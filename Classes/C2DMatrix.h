...
public:
  ...
  inline void  Rotate(const Point &fwd, const Point &side);

   //applys a transformation matrix to a std::vector of points
  inline void TransformVector2Ds(std::vector<Point> &vPoints);

  //applys a transformation matrix to a point
  inline void TransformVector2Ds(Point &vPoint);
...
inline void C2DMatrix::TransformVector2Ds(std::vector<Point> &vPoint)
{
...
inline void C2DMatrix::TransformVector2Ds(Point &vPoint)
{
...
inline void C2DMatrix::Rotate(const Point &fwd, const Point &side)
{
  C2DMatrix::Matrix mat;
